...
export default function App() {
  ...
  const renderCurrentPage = () => {
    switch (currentPage) {
      ...
      case 'medications':
        return <MedicationsDetail onClose={handleBackToDashboard} />;
      case 'water':
        return <WaterIntakeDetail onClose={handleBackToDashboard} />;
      case 'meals':
        return <MealTrackingDetail onClose={handleBackToDashboard} />;
      case 'features':
      ...
      {/* Swipe hint */}
      <div className="swipe-hint" onClick={handleSwipeLeft}>
